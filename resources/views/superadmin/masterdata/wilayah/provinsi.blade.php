...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-centre">
                                                        <a href="#" class="btn btn-sm btn-flat btn-warning" data-toggle="modal" data-target="#exampleModalEditProvinsi{{ $data->provinsi_id }}"><i class="fa fa-edit"></i></a>
                                                        <a href=" {{ route('delete-provinsi', $data->provinsi_id) }} " class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                                </tbody>
                                            ...
                                            <div class="card-footer py-4">
                                                {{ $provinsi->links('vendor.pagination.bootstrap-4') }}
                                                {{--  <nav aria-label="...">
      ...
      <!-- Modal Add -->
      @include('superadmin.masterdata.wilayah.add-provinsi')

      <!-- Modal Edit -->
      @include('superadmin.masterdata.wilayah.edit-provinsi')
