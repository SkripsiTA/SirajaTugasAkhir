...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
                                        ...
                                        <div class="card">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="row"> {{ $data->nama_kecamatan }} </th>
                                                    <td> {{ $data->kabupaten->nama_kabupaten }} </td>
                                                    <td class="text-centre">
                                                        <a href="#" class="btn btn-sm btn-flat btn-warning" data-toggle="modal" data-target="#exampleModalEditKecamatan{{ $data->kecamatan_id }}"><i class="fa fa-edit"></i></a>
                                                        <a href=" {{ route('delete-kecamatan', $data->kecamatan_id) }} " class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                                </tbody>
                                            ...
                                            <div class="card-footer py-4">
                                                {{ $kecamatan->links('vendor.pagination.bootstrap-4') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      <!-- Modal Add -->
      @include('superadmin.masterdata.wilayah.add-kecamatan')

      <!-- Modal Edit -->
      @include('superadmin.masterdata.wilayah.edit-kecamatan')
