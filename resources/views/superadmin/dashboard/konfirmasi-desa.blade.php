...
<body>
  ...
  <div class="modal fade" id="formTolak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
        <form action="{{ route('pendaftaran-desa-ditolak') }}" id="myForm" name="myForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="modal-body">
                ...
                <div class="text-center">
                    <div class="icon icon-shape text-center rounded-circle" style="width:70px; height:70px;">
                        <i class="fas fa-exclamation-triangle" style="font-size:64px;color:rgb(226, 149, 17);margin-bottom:10px"></i>
                    </div>
                </div>
                <input type="hidden" id="desa_adat_id" name="desa_adat_id" value="{{ $desaadatpending->desa_adat_id }}">
                <div class="pl-lg-12">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="form-group">
                            <label class="form-control-label" for="input-email">Alasan Penolakan</label>
                            <input type="text" id="desadat_keterangan" class="form-control" placeholder="Alasan Penolakan" name="desadat_keterangan">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btn_save" value="add">Simpan</button>
            </div>
        </form>
        </div>
    </div>
  ...
  {{--  <script type="text/javascript">
    $(document).ready(function ($) {
        ...
        $('#btn_save').click(function (event) {
            var desa_adat_id = $("#desa_adat_id").val();
            var desadat_keterangan = $("#desadat_keterangan").val();
            ...
            $.ajax({
                ...
                data: {
                    ...
                    desadat_keterangan: desadat_keterangan,
                },
                dataType: 'json',
