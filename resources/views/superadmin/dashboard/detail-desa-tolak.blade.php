                    ...
                    <div class="card shadow">
                        <form class="contact-form" enctype="multipart/form-data">
                            <div class="card-body text-left">
                                ...
                                <div class="form-section">
                                    <hr class="my-4" />
                                    <h5 class="heading-small text-muted mb-4">Alasan Penolakan</h5>
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <textarea rows="4" name="sejarah_desa" class="form-control" placeholder="Sejarah Desa" value="">{{ $desaadatdetail->desadat_keterangan }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
