            ...
            <table style="border: 1px solid transparent;" align="center">
                ...
                <tr>
                    <td colspan="2" class="text-center">
                        <font size="4" class="text-uppercase font-weight-bold" style="font-family: TimesNewRoman;" color="#444444">Data Surat Masuk </font><br><br><br>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <table class="table align-items-left table-flush" style="border: 2px solid black;">
                            <thead class="thead-light" style="border: 2px solid black;">
                                <tr class="text-left" style="border: 2px solid black;">
                                    <th class="col-sm-1" style="border: 2px solid; color:#444444;">No</th>
                                    <th class="col-3" style="border: 2px solid; color:#444444;">Kode Surat</th>
                                    <th class="col-3" style="border: 2px solid; color:#444444;">Parindikan</th>
                                    <th class="col-2" style="border: 2px solid; color:#444444;">Tanggal Surat</th>
                                    <th class="col-1" style="border: 2px solid; color:#444444;">Mawit Saking</th>
                                    <th class="col-1" style="border: 2px solid; color:#444444;">Tanggal Masuk</th>
                                    <th class="col-1" style="border: 2px solid; color:#444444;">Prajuru Desa Adat</th>
                                </tr>
                            </thead>
                            ...
                            @foreach ($suratmasuk as $data)
                                <tr style="border: 2px solid black;">
                                    ...
                                    <td style="border: 2px solid; color:#444444;"> {{ $data->perihal }} </td>
                                    @if($data->tanggal_surat != null)
                                        <td style="border: 2px solid; color:#444444;"> {{ showDateTime($data->tanggal_surat, 'd F Y') }}</td>
                                    @else
                                        <td style="border: 2px solid; color:#444444;">{{ $data->tanggal_surat }}</td>
                                    @endif
                                    <td style="border: 2px solid; color:#444444;"> {{ $data->asal_surat }} </td>
                                    <td style="border: 2px solid; color:#444444;">{{ showDateTime($data->tanggal_diterima, 'd F Y') }}</td>
                                    <td style="border: 2px solid; color:#444444;"> {{ $data->prajurudesaadat->kramamipil->cacahkramamipil->penduduk->nama }} </td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
