            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-10">
                            <h3 class="mb-0">File Surat Masuk</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="col-lg-12">
                        <iframe src="{{ asset('assets/file/surat-masuk/'.$suratmasuk->file ) }}"  height="1200" width="100%" style="margin-Top :5px;"></iframe>
                    </div>
                </div>
                <div class="card-footer text-right">
                    <a href="{{ route('detail-surat-masuk', $suratmasuk->surat_masuk_id) }}" type="button" class="btn btn-secondary">Kembali</a>
                </div>
            </div>
        </div>
      </div>
