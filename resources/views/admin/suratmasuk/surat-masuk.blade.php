                ...
                <div class="card-header">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="float-right">
                            <a href="{{ route('cetak-daftar-surat-masuk') }}" type="button" class="btn btn-md btn-danger" target="_blank"><i class="fa fa-print"></i>
                            PDF</a>
                            <a href="{{ route('create-surat-masuk') }}" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i>
                            Tambah</a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <table class="table align-items-left table-flush">
                                                ...
                                                @foreach ($suratmasuk as $data)
                                                    <tr>
                                                        ...
                                                        <td>{{ showDateTime($data->tanggal_diterima, 'd F Y') }}</td>
                                                        <td> {{ $data->prajurudesaadat->kramamipil->cacahkramamipil->penduduk->nama }} </td>
                                                        <td>
                                                            <a href="{{ route('file-surat-masuk', $data->surat_masuk_id) }}" class="view btn btn-sm btn-flat btn-default">Detail<i class="fa fa-file"></i></a>
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="{{ route('detail-surat-masuk', $data->surat_masuk_id) }}" class="view btn btn-sm btn-flat btn-info"><i class="fa fa-eye"></i></a>
                                                            <a href="{{ route('edit-surat-masuk', $data->surat_masuk_id) }}" class="btn btn-sm btn-flat btn-warning"><i class="fa fa-edit"></i></a>
                                                            <button type="submit" class="btn btn-sm btn-flat btn-danger delete" data-id="{{ $data->surat_masuk_id }}"><i class="fa fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
