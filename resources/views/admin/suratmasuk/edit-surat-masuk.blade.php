      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="{{ route('update-surat-masuk', $suratmasuk->surat_masuk_id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_surat_masuk" class="form-control" id="nomor_surat_masuk" placeholder="Nomor Surat" value="{{ $suratmasuk->nomor_surat }}" required>
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Parindikan<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="parindikan" class="form-control" id="parindikan" placeholder="Parindikan" value="{{ $suratmasuk->perihal }}" required>
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Mawit Saking<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="mawit_saking" class="form-control" id="mawit_saking" placeholder="Mawit Saking" value="{{ $suratmasuk->asal_surat }}" required>
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="tanggal_surat" class="form-control datepicker1" placeholder="Tanggal Surat" type="text" value="{{ $suratmasuk->tanggal_surat }}" required>
                                    </div>
                                </div>
                              </div>
                          </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_mulai" placeholder="Tanggal Kegiatan Mulai" type="text" value="{{ $suratmasuk->tanggal_kegiatan_mulai }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_berakhir" placeholder="Tanggal Kegiatan Selesai" type="text" value="{{ $suratmasuk->tanggal_kegiatan_berakhir }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_mulai" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Mulai" value="{{ $suratmasuk->waktu_kegiatan_mulai }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_berakhir" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Selesai" value="{{ $suratmasuk->waktu_kegiatan_berakhir }}">
                                    </div>
                                </div>
                            </div>
                          </div>
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('dashboard-surat-masuk') }}" type="button" class="btn btn-secondary">Batal</a>
