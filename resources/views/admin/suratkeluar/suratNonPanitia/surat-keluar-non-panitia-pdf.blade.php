                ...
                <tr>
                    <td colspan="2">
                        ...
                        @if($suratkeluarnonpanitia->tanggal_kegiatan_mulai != null && $suratkeluarnonpanitia->tanggal_kegiatan_berakhir != null)
                            <font size="3" style="font-family: TimesNewRoman;" color="#444444"><span class="tab"></span>Rahina : {{ showDateTime($suratkeluarnonpanitia->tanggal_kegiatan_mulai, 'l, d F Y') }} - {{ showDateTime($suratkeluarpanitia->tanggal_kegiatan_berakhir, 'l, d F Y') }}</font><br>
                        @endif
