                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        ...
                        <div class="float-right">
                            <a href="{{ route('cetak-daftar-surat-keluar-non-panitia') }}" type="button" class="btn btn-md btn-danger" target="_blank"><i class="fa fa-print"></i>
                            PDF</a>
                            <a href="{{ route('create-surat-keluar-non-panitia') }}" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i>
                            Tambah</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <h3 class="mb-0">Data Surat Keluar Non Panitia</h3>
                                            </div>
                                            <!-- Light table -->
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="{{ route('detail-surat-keluar-non-panitia', $data->surat_keluar_id) }}" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-eye"></i></a>
                                                    </td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-items-center table-flush">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a href="{{ route('detail-surat-keluar-non-panitia-inprogress', $data->surat_keluar_id) }}" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-eye"></i></a>
                                                        </td>
