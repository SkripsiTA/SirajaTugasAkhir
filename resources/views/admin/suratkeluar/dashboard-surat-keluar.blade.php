                ...
                <div class="col-xl-3 col-md-6">
                  <div class="card card-stats">
                    ...
                    <div class="card-body">
                      ...
                      <a href="{{ route('home-surat-keluar-panitia') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-xl-3 col-md-6">
                ...
                <div class="card-header">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="float-right">
                            <a href="" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i>
                            Tambah</a>
                        </div>
                    </div>
