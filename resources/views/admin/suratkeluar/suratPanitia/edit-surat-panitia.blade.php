      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="{{ route('update-surat-keluar-panitia', $suratkeluarpanitia->surat_keluar_id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="lepihan" class="form-control" id="lepihan" placeholder="Lepihan" value="{{ $suratkeluarpanitia->lepihan }}">
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Parindikan<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="parindikan" class="form-control" id="parindikan" placeholder="Parindikan" value="{{ $suratkeluarpanitia->parindikan }}">
                                </div>
                              </div>
                              <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Tetujon<i class="text-danger text-sm text-bold">*</i></label>
                                    <input type="text" name="tetujon" class="form-control" id="tetujon" placeholder="Tetujon" value="{{ $suratkeluarpanitia->pihak_penerima }}">
                                </div>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea rows="4" name="pemahbah_surat" class="form-control" placeholder="Pemahbah Surat">{{ $suratkeluarpanitia->pamahbah_surat }}</textarea>
                            </div>
                          </div>
                          <div class="col-lg-12">
                              <div class="form-group">
                                  <label class="form-control-label" for="input-username">Daging Surat</label>
                                  <textarea rows="4" name="daging_surat" class="form-control" placeholder="Daging Surat">{{ $suratkeluarpanitia->daging_surat }}</textarea>
                              </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="input-username">Pamuput Surat</label>
                                <textarea rows="4" name="pamuput_surat" class="form-control" placeholder="Pamuput Surat">{{ $suratkeluarpanitia->pamuput_surat }}</textarea>
                            </div>
                          </div>
                          <div class="col-lg-12">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_mulai" placeholder="Tanggal Kegiatan Mulai" type="text" value="{{ $suratkeluarpanitia->tanggal_kegiatan_mulai }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="tanggal_kegiatan_berakhir" placeholder="Tanggal Kegiatan Selesai" type="text" value="{{ $suratkeluarpanitia->tanggal_kegiatan_berakhir }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_mulai" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Mulai" value="{{ $suratkeluarpanitia->waktu_kegiatan_mulai }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <input type="time" name="waktu_kegiatan_berakhir" class="form-control" id="waktu_kegiatan" placeholder="Waktu Kegiatan Selesai" value="{{ $suratkeluarpanitia->waktu_kegiatan_selesai }}">
                                    </div>
                                </div>
                              </div>
                            </div>
                          <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="busana" class="form-control" id="busana" placeholder="Busana/Pakaian" value="{{ $suratkeluarpanitia->busana }}">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="input-email">Tempat Kegiatan</label>
                                <input type="text" name="tempat_kegiatan" class="form-control" id="tempat_kegiatan" placeholder="Tempat Kegiatan" value="{{ $suratkeluarpanitia->tempat_kegiatan }}">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="input-email">Panitia Acara<i class="text-danger text-sm text-bold">*</i></label>
                                <input type="text" name="tim_kegiatan" class="password form-control" id="tim_kegiatan" placeholder="Panitia Acara" value="{{ $suratkeluarpanitia->tim_kegiatan }}">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                            ...
                            <input type="file" name="lepihan_surat" class="form-control" placeholder="Lepihan Surat" value="{{ $suratkeluarpanitia->lampiran }}" accept="application/pdf">
                            </div>
                        </div>
                        </div>
                      </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="sekretaris_panitia" class="sekretaris_panitia form-control" id="sekretaris_panitia" style="height: 100%">
                                      @if ($suratkeluarpanitia->validasipanitia[1]->krama_mipil_id != null)
                                      <option value="{{ $suratkeluarpanitia->validasipanitia[1]->krama_mipil_id }}">{{ $suratkeluarpanitia->validasipanitia[1]->kramamipil->cacahkramamipil->penduduk->nama }}</option>
                                      @endif
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="ketua_panitia" class="ketua_panitia form-control" id="ketua_panitia" style="height: 100%">
                                      <option value="{{ $suratkeluarpanitia->validasipanitia[0]->krama_mipil_id }}">{{ $suratkeluarpanitia->validasipanitia[0]->kramamipil->cacahkramamipil->penduduk->nama }}</option>
                                      @foreach ($kramamipil as $data)
                                          <option value="{{ $data->krama_mipil_id }}" data-id="{{ $data->cacahkramamipil->penduduk->nik }}">{{ $data->cacahkramamipil->penduduk->nik }} - {{ $data->cacahkramamipil->penduduk->nama }}</option>
                                      @endforeach
                                    </select>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tumusan" class="form-control" id="tumusan" placeholder="Tumusan" value="{{ $suratkeluarpanitia->tumusan }}">
                                </div>
                              </div>
                          </div>
                      </div>
