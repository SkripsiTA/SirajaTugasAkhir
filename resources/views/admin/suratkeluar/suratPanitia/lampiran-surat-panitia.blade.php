      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <iframe src="{{ asset('assets/file/lampiran/surat-keluar/'.$suratkeluarpanitia->lampiran ) }}"  height="1200" width="100%" style="margin-Top :5px;"></iframe>
                    </div>
                </div>
                <div class="card-footer text-right">
                    <a href="{{ route('detail-surat-keluar-panitia', $suratkeluarpanitia->surat_keluar_id) }}" type="button" class="btn btn-secondary">Kembali</a>
                </div>
            </div>
        </div>
      </div>
