      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="{{ route('update-prajuru-banjar-adat', $editprajurubanjar->prajuru_banjar_adat_id) }}" method="POST">
                    {{ csrf_field() }}
                    <div class="card-body">
                              ...
                              <div class="col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <select name="kramamipil_id" class="kramamipil_id form-control" id="kramamipil_id" style="height: 100%" readonly>
                                        <option value="{{ $editprajurubanjar->krama_mipil_id }}">{{ $editprajurubanjar->kramamipil->cacahkramamipil->penduduk->nik }} - {{ $editprajurubanjar->kramamipil->cacahkramamipil->penduduk->nama }}</option>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="banjar_adat" class="form-control" id="banjar_adat" required>
                                        ...
                                        <option value="{{ $editprajurubanjar->banjar_adat_id }}" selected>{{ $editprajurubanjar->banjaradat->nama_banjar_adat }}</option>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_mulai" placeholder="Periode Mulai" type="text" value="{{ $editprajurubanjar->tanggal_mulai_menjabat }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_berakhir" placeholder="Periode Berakhir" type="text" value="{{ $editprajurubanjar->tanggal_akhir_menjabat }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{ $editprajurubanjar->banjaradat->desaadat->user[0]->email }}" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
