            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Detail Prajuru Banjar Adat</h3>
                        </div>
                    </div>
                </div>
                <form >
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <select name="kramamipil_id" class="kramamipil_id form-control" id="kramamipil_id" style="height: 100%" disabled>
                                        <option value="{{ $detailprajurubanjar->krama_mipil_id }}">{{ $detailprajurubanjar->kramamipil->cacahkramamipil->penduduk->nik }} - {{ $detailprajurubanjar->kramamipil->cacahkramamipil->penduduk->nama }}</option>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="nama_jabatan" class="form-control" id="nama_jabatan" disabled>
                                        <option value="{{ $detailprajurubanjar->jabatan }}">{{ $detailprajurubanjar->jabatan }}</option>
                                        {{--  <option value="kelihan banjar" <?= $editprajurubanjar->jabatan === 'kelihan banjar' ? 'selected' : '' ?>>Kelihan Banjar</option>
                                        <option value="pangliman" <?= $editprajurubanjar->jabatan === 'pangliman' ? 'selected' : '' ?>>Pangliman</option>
                                        <option value="penyarikan" <?= $editprajurubanjar->jabatan === 'penyarikan' ? 'selected' : '' ?>>Penyarikan</option>
                                        <option value="patengen" <?= $editprajurubanjar->jabatan === 'patengen' ? 'selected' : '' ?>>Patengen</option>  --}}
                                    </select>
                                </div>
                              </div>
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="status_prajuru_banjar" class="form-control" id="status_prajuru_banjar" disabled>
                                        <option value="{{ $detailprajurubanjar->status_prajuru_banjar_adat }}">{{ $detailprajurubanjar->status_prajuru_banjar_adat }}</option>
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="banjar_adat" class="form-control" id="banjar_adat" disabled>
                                        <option value="{{ $detailprajurubanjar->banjar_adat_id }}" selected>{{ $detailprajurubanjar->banjaradat->nama_banjar_adat }}</option>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_mulai" placeholder="Periode Mulai" type="text" value="{{ showDateTime($detailprajurubanjar->tanggal_mulai_menjabat, 'd F Y') }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="masa_berakhir" placeholder="Periode Berakhir" type="text" value="{{ showDateTime($detailprajurubanjar->tanggal_akhir_menjabat, 'd F Y') }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{ $detailprajurubanjar->banjaradat->desaadat->user[0]->email }}" disabled>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Password</label>
                                    <input type="password" name="password" class="password form-control" id="password" placeholder="Password" value="{{ $detailprajurubanjar->banjaradat->desaadat->user[0]->password }}" disabled>
                                </div>
                            </div>
                        </div>
                      </div>
