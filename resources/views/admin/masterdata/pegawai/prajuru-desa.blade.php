                ...
                <div class="card-header">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="float-right">
                            <a href="{{ route('create-prajuru-desa-adat') }}" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i>
                            Tambah</a>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <h3 class="mb-0">Data Prajuru Desa Adat {{ Auth::user()->desaadat->desadat_nama }}</h3>
                                            </div>
                                            <!-- Light table -->
                                            ...
                                            <table class="table align-items-left table-flush">
                                                ...
                                                @foreach ($prajurudesa as $data)
                                                    <tr>
                                                        ...
                                                        <td> {{ $data->jabatan }} </td>
                                                        <td> {{ $data->status_prajuru_desa_adat }} </td>
                                            ...
                                            <div class="card-footer py-4">
                                                {{ $prajurudesa->links('vendor.pagination.bootstrap-4') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
