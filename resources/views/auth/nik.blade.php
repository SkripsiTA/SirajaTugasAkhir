...
<body class="main-content color-swatch-header bg-secondary">
    ...
    <div class="wrapper">
        <!-- Header -->
        <div class="header bg-gradient-secondary py-0 py-lg-8 pt-lg-0">
            <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7">
                        ...
                        <div class="card-body px-lg-5 py-lg-2">
                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary my-4">Lanjutkan</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-6 text-right">
                        <a href="/login" class="text-primary"><small>Masuk ke akun</small></a>
                    </div>
                    </div>
                </div>
            </div>
