<div class="header pb-6 d-flex align-items-center" style="min-height: 500px; background-image: url(<?php echo e(asset('assets/img/theme/desa.jpg')); ?>); background-size: cover; background-position: center top;">
    ...
    <div class="row">
        ...
        <a href="/profile/edit/<?php echo e(Auth::user()->user_id); ?>" class="btn btn-neutral">Edit profile</a>
        </div>
    </div>
    </div>
</div>
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>