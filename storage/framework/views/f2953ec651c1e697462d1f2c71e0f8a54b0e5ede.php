...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <tr>
                                                    <td> <?php echo e($data->kabupaten_id); ?> </td>
                                                    <th scope="row"> <?php echo e($data->nama_kabupaten); ?> </th>
                                                    <td> <?php echo e($data->provinsi->nama_provinsi); ?> </td>
                                                    <td class="text-centre">
                                                        <a href="#" class="btn btn-sm btn-flat btn-warning" data-toggle="modal" data-target="#exampleModalEditKabupaten <?php echo e($data->kabupaten_id); ?>"><i class="fa fa-edit"></i></a>
                                                        <a href=" <?php echo e(route('delete-kabupaten', $data->kabupaten_id)); ?> " class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="card-footer py-4">
                                                <?php echo e($kabupaten->links('vendor.pagination.bootstrap-4')); ?>
      ...
      <!-- Modal Add -->
      <?php echo $__env->make('superadmin.masterdata.wilayah.add-kabupaten', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

      <!-- Modal Edit -->
      <?php echo $__env->make('superadmin.masterdata.wilayah.edit-kabupaten', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/superadmin/masterdata/wilayah/kabupaten.blade.php ENDPATH**/ ?>