            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-lg-12 col-7 text-right">
                        <a href="<?php echo e(route('create-kepala-dusun')); ?>" type="button" class="btn btn-md btn-primary"><i class="fa fa-plus"></i>
                        Tambah</a>
                        <a href="<?php echo e(route('create-dusun')); ?>" type="button" class="btn btn-md btn-default"><i class="fa fa-plus"></i>
                        Tambah Dusun</a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <table class="table align-items-left table-flush">
                                                ...
                                                <tbody class="list">
                                                <?php $__currentLoopData = $kepaladusun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td> <?php echo e($data->dusun->dusun_id); ?> </td>
                                                        <td> <?php echo e($data->dusun->nama_dusun); ?> </td>
                                                        <td> <?php echo e($data->penduduk->nama_lengkap); ?> </td>
                                                        <td> <?php echo e($data->status); ?> </td>
                                                        <td><?php echo e(showDateTime($data->periode_mulai, 'd F Y')); ?></td>
                                                        <td><?php echo e(showDateTime($data->periode_selesai, 'd F Y')); ?></td>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/admin/masterdata/dusun/kepala-dusun.blade.php ENDPATH**/ ?>