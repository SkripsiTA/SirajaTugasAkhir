                ...
                <div class="card card-profile">
                  ...
                  <div class="card-body pt-3">
                    <div class="text-center">
                      <h5 class="h3">
                        <?php echo e(Auth::user()->penduduk->nama_lengkap); ?><span class="font-weight-light">, 27</span>
                      </h5>
                      <div class="h5 font-weight-300">
                        <i class="ni location_pin mr-2"></i><?php echo e(Auth::user()->desa->nama_desa); ?>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="penduduk_id" class="form-control" placeholder="NIK" value="<?php echo e(Auth::user()->penduduk->penduduk_id); ?>" disabled>
                          </div>
                        </div>
                        <div class="col-lg-8">
                          <div class="form-group">
                            <label class="form-control-label" for="input-email">Nama Lengkap</label>
                            <input type="text" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" value="<?php echo e(Auth::user()->penduduk->nama_lengkap); ?>" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="nama_desa" class="form-control" placeholder="Desa" value="<?php echo e(Auth::user()->desa->nama_desa); ?>" disabled>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="form-control-label" for="input-country">Kode Pos</label>
                            <input type="number" name="kode_pos" class="form-control" placeholder="Kode Pos" value="<?php echo e(Auth::user()->desa->kode_pos); ?>" disabled>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="nama_pekerjaan" class="form-control" placeholder="Pekerjaan" value="<?php echo e(Auth::user()->penduduk->pekerjaan->nama_pekerjaan); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/admin/dashboard/profile.blade.php ENDPATH**/ ?>