                                ...
                                <div class="form-section">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input name="nomor_register_desa" class="form-control" placeholder="Nomor Registrasi Desa (otomatis)" value="<?php echo e($desaadatdetail->desadat_nomor_register); ?>" type="text" disabled>
                                        </div>
                                    </div>
                                    <hr class="my-4" />
                                    <!-- Address -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="alamat_desa" class="form-control" placeholder="Alamat Kantor Desa" value="<?php echo e($desaadatdetail->kecamatan->kabupaten->provinsi->name); ?>" type="text" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                <label class="form-control-label" for="input-email">Kabupaten<i class="text-danger text-sm text-bold">*</i></label>
                                                <input name="alamat_desa" class="form-control" placeholder="Alamat Kantor Desa" value="<?php echo e($desaadatdetail->kecamatan->kabupaten->name); ?>" type="text" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="alamat_desa" class="form-control" placeholder="Alamat Kantor Desa" value="<?php echo e($desaadatdetail->kecamatan->name); ?>" type="text" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                <label class="form-control-label" for="input-last-name">Desa<i class="text-danger text-sm text-bold">*</i></label>
                                                <input name="alamat_desa" class="form-control" placeholder="Alamat Kantor Desa" value="<?php echo e($desaadatdetail->desadat_nama); ?>" type="text" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                <label class="form-control-label" for="input-kodewilayah">Kode Wilayah<i class="text-danger text-sm text-bold">*</i></label>
                                                <input type="text" name="kode_wilayah" class="form-control" placeholder="Kode Wilayah" value="<?php echo e($desaadatdetail->desadat_kode); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-kodepos">Kode Pos<i class="text-danger text-sm text-bold">*</i></label>
                                                    <input type="text" name="kode_pos" class="form-control" placeholder="Kode Pos" value="<?php echo e($desaadatdetail->desadat_kode_pos); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                ...
                                                <select name="status_desa" class="form-control" id="status_desa" disabled>
                                                    <option value="<?php echo e($desaadatdetail->desadat_status_aktif); ?>"><?php if($desaadatdetail->desadat_status_aktif == "1"): ?>Aktif <?php else: ?> Tidak Aktif <?php endif; ?></option>
                                                </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                ...
                                                <input name="alamat_desa" class="form-control" placeholder="Alamat Kantor Desa" value="<?php echo e($desaadatdetail->desadat_alamat_kantor); ?>" type="text" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="telepon_desa" class="form-control" placeholder="Telepon" value="<?php echo e($desaadatdetail->desadat_telpon_kantor); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                <label class="form-control-label" for="input-country">Whatsapp<i class="text-danger text-sm text-bold">*</i></label>
                                                <input type="text" name="kontak_wa" class="form-control" placeholder="Whatsapp" value="<?php echo e($desaadatdetail->desadat_wa_kontak_1); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                <label class="form-control-label" for="input-country">Faximile<i class="text-danger text-sm text-bold">*</i></label>
                                                <input type="text" name="fax_desa" class="form-control" placeholder="Faximile" value="<?php echo e($desaadatdetail->desadat_fax_kantor); ?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input name="email_desa" class="form-control" placeholder="Email Desa" value="<?php echo e($desaadatdetail->desadat_email); ?>" type="email" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                <label class="form-control-label" for="input-address">Web Desa<i class="text-danger text-sm text-bold">*</i></label>
                                                <input name="web_desa" class="form-control" placeholder="Web Desa" value="<?php echo e($desaadatdetail->desadat_web); ?>" type="url" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="number" name="luas_desa" class="form-control" placeholder="Luas Desa" value="<?php echo e($desaadatdetail->desadat_luas); ?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                <label class="form-control-label" for="input-country">Struktur Organisasi Desa<i class="text-danger text-sm text-bold">*</i></label>
                                                <input type="text" name="file_struktur_pem" class="form-control" placeholder="Struktur Pembentukan Desa" value="<?php echo e($desaadatdetail->desadat_file_struktur_pem); ?>" disabled><iframe src="<?php echo e(asset('assets/img/struktur-desa/'.$desaadatdetail->desadat_file_struktur_pem )); ?>"  height="500px" width="100%" style="margin-Top :5px;"></iframe>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-country">Logo Desa<i class="text-danger text-sm text-bold">*</i></label>
                                                    <input type="text" name="logo_desa" class="form-control" value="<?php echo e($desaadatdetail->desadat_logo); ?>" placeholder="Logo Desa" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <img  src="<?php echo e(asset('assets/img/logo-desa/'.$desaadatdetail->desadat_logo)); ?>" style="width:250px; height:250px;" alt="user-img">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea rows="4" name="sejarah_desa" class="form-control" placeholder="Sejarah Desa" value="" disabled><?php echo e($desaadatdetail->desadat_sejarah); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="sebutan_pemimpin" class="form-control" placeholder="Sebutan Pemimpin" value="<?php echo e($desaadatdetail->desadat_sebutan_pemimpin); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="kramamipil_id" class="kramamipil_id form-control" id="kramamipil_id" style="height: 100%" disabled>
                                                        <option value="<?php echo e($desaadatdetail->prajurudesaadat[0]->krama_mipil_id); ?>"><?php echo e($desaadatdetail->prajurudesaadat[0]->kramamipil->cacahkramamipil->penduduk->nik); ?> - <?php echo e($desaadatdetail->prajurudesaadat[0]->kramamipil->cacahkramamipil->penduduk->nama); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" name="masa_mulai" placeholder="Periode Mulai" type="text" value="<?php echo e(showDateTime($desaadatdetail->prajurudesaadat[0]->tanggal_mulai_menjabat, 'd F Y')); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" name="masa_berakhir" placeholder="Periode Berakhir" type="text" value="<?php echo e(showDateTime($desaadatdetail->prajurudesaadat[0]->tanggal_akhir_menjabat, 'd F Y')); ?>" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="sebutan_pemimpin" class="form-control" placeholder="Sebutan Pemimpin" value="<?php echo e($desaadatdetail->user[0]->email); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">Password<i class="text-danger text-sm text-bold">*</i></label>
                                                    <input type="password" name="sebutan_pemimpin" class="form-control" placeholder="Sebutan Pemimpin" value="<?php echo e($desaadatdetail->user[0]->password); ?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/superadmin/dashboard/detail-desa.blade.php ENDPATH**/ ?>