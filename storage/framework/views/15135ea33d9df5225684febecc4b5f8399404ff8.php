                        ...
                        <div class="card-body px-lg-5 py-lg-2">
                            <div class="text-center text-muted mb-4">
                                <div class="col-lg-10 col-10 mx-md-auto">
                                    <img class="ml-lg-10" src="<?php echo e(asset('assets/img/brand/login.png')); ?>" width="100%">
                                </div>
                                <small>Login dengan</small>
                            </div>
                            <form action="<?php echo e(url('loginsession')); ?>" method="POST" id="logForm">
...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e(asset('asset/demo/jquery.sharrre.js')); ?>"></script>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/auth/login.blade.php ENDPATH**/ ?>