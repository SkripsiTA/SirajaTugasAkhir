<nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-primary navbar-light py-2">
    <div class="container">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            <li class="nav-item">
                <a href="<?php echo e(route('create-desa-adat')); ?>" class="nav-link">
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/theme/navbar.blade.php ENDPATH**/ ?>