        ...
        <div class="container-fluid mt--6 text-center">
            <div class="row justify-content-center">
                <div class="col-xl-8 order-xl-1">
                        ...
                        <div class="col-12">
                            <div class="text-center text-muted mb-4">
                                <div class="col-sm-10 col-10 mx-md-auto">
                                    <img class="col-sm-4" src="<?php echo e(asset('assets/img/brand/logo.png')); ?>" width="100%">
                    ...
                    <form class="contact-form" method="POST" action="<?php echo e(route('save-desa-adat')); ?>" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select name="provinsi" class="form-control" id="provinsi" required>
                                            ...
                                            <option value="<?php echo e($provinsi->provinsi_id); ?>"><?php echo e($provinsi->name); ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kramamipil_id" class="kramamipil_id form-control" id="kramamipil_id" style="height: 100%" required>
                                                  ...
                                                  <?php $__currentLoopData = $kramamipil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                      <option value="<?php echo e($data->krama_mipil_id); ?>"><?php echo e($data->cacahkramamipil->penduduk->nik); ?> - <?php echo e($data->cacahkramamipil->penduduk->nama); ?></option>
        ...
        $(function(){
            ...
            $(function() {
                $('#provinsi').on('change', function() {
                    ...
                    $.ajax({
                        type : 'POST',
                        url : '<?php echo e(route('get-kabupaten')); ?>',
                ...
                $('#kecamatan').on('change', function() {
                    ...
                    $.ajax({
                        type : 'POST',
                        url : '<?php echo e(route('get-desa-adat')); ?>',
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/auth/daftar-desa.blade.php ENDPATH**/ ?>