      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo e(route('add-prajuru-desa-adat')); ?>" method="POST">
                              ...
                              <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="nama_jabatan" class="form-control" id="nama_jabatan" required>
                                        ...
                                        <option value="bendesa" <?= $prajurudesa->jabatan === 'bendesa' ? 'selected' : '' ?>>Bendesa</option>
                                        <option value="pangliman" <?= $prajurudesa->jabatan === 'pangliman' ? 'selected' : '' ?>>Pangliman</option>
                                        <option value="penyarikan" <?= $prajurudesa->jabatan === 'penyarikan' ? 'selected' : '' ?>>Penyarikan</option>
                                        <option value="patengen" <?= $prajurudesa->jabatan === 'patengen' ? 'selected' : '' ?>>Patengen</option>
                                        <option value="kasinoman" <?= $prajurudesa->jabatan === 'kasinoman' ? 'selected' : '' ?>>Kasinoman</option>
                                        <option value="baga palemahan" <?= $prajurudesa->jabatan === 'baga palemahan' ? 'selected' : '' ?>>Baga Palemahan</option>
                                    </select>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="status_prajuru_desa" class="form-control" id="status_prajuru_desa" required>
                                        ...
                                        <option value="aktif" <?= $prajurudesa->status_prajuru_desa_adat === 'aktif' ? 'selected' : '' ?>>Aktif</option>
                                        <option value="tidak aktif" <?= $prajurudesa->status_prajuru_desa_adat === 'tidak aktif' ? 'selected' : '' ?>>Tidak Aktif</option>
                                    </select>
                                </div>
                              </div>
                              <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="role_prajuru" class="form-control" id="role_prajuru" required>
                                        <option value="">-- Pilih Role Prajuru --</option>
                                        <option value="Bendesa" <?= $akun->role === 'Bendesa' ? 'selected' : '' ?>>Bendesa</option>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/admin/masterdata/pegawai/add-prajuru-desa.blade.php ENDPATH**/ ?>