...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-lg-12 col-7 text-right">
                        <a href="#" type="button" class="btn btn-md btn-primary" data-toggle="modal" data-target="#exampleModalAddKecamatan"><i class="fa fa-plus"></i>
                        Tambah</a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <tr>
                                                    <th scope="col" class="sort" data-sort="kecamatan_id">Kode Kecamatan</th>
                                                    <th scope="col" class="sort" data-sort="nama_kecamatan">Nama</th>
                                                    <th scope="col" class="sort" data-sort="kabupaten_id">Kabupaten</th>
                                                ...
                                                <tr>
                                                    <td> <?php echo e($data->kecamatan_id); ?> </td>
                                                    <th scope="row"> <?php echo e($data->nama_kecamatan); ?> </th>
                                                    <td> <?php echo e($data->kabupaten->nama_kabupaten); ?> </td>
                                                    <td class="text-centre">
                                                        <a href="#" class="btn btn-sm btn-flat btn-warning" data-toggle="modal" data-target="#exampleModalEditKecamatan<?php echo e($data->kecamatan_id); ?>"><i class="fa fa-edit"></i></a>
                                                        <a href=" <?php echo e(route('delete-kecamatan', $data->kecamatan_id)); ?> " class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="card-footer py-4">
                                                <?php echo e($kecamatan->links('vendor.pagination.bootstrap-4')); ?>
      ...
      <!-- Modal Add -->
      <?php echo $__env->make('superadmin.masterdata.wilayah.add-kecamatan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

      <!-- Modal Edit -->
      <?php echo $__env->make('superadmin.masterdata.wilayah.edit-kecamatan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/superadmin/masterdata/wilayah/kecamatan.blade.php ENDPATH**/ ?>