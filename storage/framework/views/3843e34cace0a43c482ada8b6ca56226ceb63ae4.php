                ...
                <div class="card card-profile">
                  ...
                  <div class="card-body pt-3">
                    <div class="text-center">
                      <h5 class="h3">
                        <?php echo e(Auth::user()->penduduk->nama); ?><span class="font-weight-light">, 27</span>
                      </h5>
                      <div class="h5 font-weight-300">
                        <i class="ni location_pin mr-2"></i><?php echo e(Auth::user()->desaadat->desadat_nama); ?>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="penduduk_id" class="form-control" placeholder="NIK" value="<?php echo e(Auth::user()->penduduk->nik); ?>" disabled>
                          </div>
                        </div>
                        <div class="col-lg-8">
                          <div class="form-group">
                            <label class="form-control-label" for="input-email">Nama Lengkap</label>
                            <input type="text" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" value="<?php echo e(Auth::user()->penduduk->nama); ?>" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" value="<?php echo e(Auth::user()->penduduk->tempat_lahir); ?>" disabled>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="form-control-label" for="input-last-name">Tanggal Lahir</label>
                            <input type="text" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir" value="<?php echo e(showDateTime(Auth::user()->penduduk->tanggal_lahir, 'd F Y')); ?>" disabled>
                          </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                              <label class="form-control-label" for="input-first-name">Jenis Kelamin</label>
                              <input type="text" name="jenis_kelamin" class="form-control" placeholder="Jenis Kelamin" value="<?php echo e(Auth::user()->penduduk->jenis_kelamin); ?>" disabled>
                            </div>
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo e(Auth::user()->username); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="form-group">
                              <label class="form-control-label" for="input-email">Email</label>
                              <input type="email" name="email" class="form-control" placeholder="Email" value="<?php echo e(Auth::user()->email); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="form-control-label" for="input-address">Alamat</label>
                            <input name="alamat" class="form-control" placeholder="Alamat" value="<?php echo e(Auth::user()->penduduk->alamat); ?>" type="text" disabled>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="nomor_telepon" class="form-control" placeholder="Nomor Telpon" value="<?php echo e(Auth::user()->nomor_telepon); ?>" disabled>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="form-control-label" for="input-country">Desa</label>
                            <input type="text" name="nama_desa" class="form-control" placeholder="Desa" value="<?php echo e(Auth::user()->desaadat->desadat_nama); ?>" disabled>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="form-control-label" for="input-country">Kode Pos</label>
                            <input type="number" name="kode_pos" class="form-control" placeholder="Kode Pos" value="<?php echo e(Auth::user()->desaadat->desadat_kode_pos); ?>" disabled>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="nama_profesi" class="form-control" placeholder="Pekerjaan" value="<?php echo e(Auth::user()->penduduk->profesi->profesi); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                              <label class="form-control-label" for="input-country">Kewarganegaraan</label>
                              <input type="text" name="kewarganegaraan" class="form-control" placeholder="Kewarganegaraan" value="<?php echo e(Auth::user()->penduduk->kewarganegaraan); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                              <label class="form-control-label" for="input-country">Golongan Darah</label>
                              <input type="text" name="golongan_darah" class="form-control" placeholder="Golongan Darah" value="<?php echo e(Auth::user()->penduduk->golongan_darah); ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <hr class="my-4" />
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="nama_ayah" class="form-control" placeholder="Ayah" value="<?php echo e(Auth::user()->penduduk->ayahkandung->nama); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="input-country">Ibu</label>
                              <input type="text" name="nama_ibu" class="form-control" placeholder="Ibu" value="<?php echo e(Auth::user()->penduduk->ibukandung->nama); ?>" disabled>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/profile/profile.blade.php ENDPATH**/ ?>