...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
                                        ...
                                        <div class="card">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php echo e($data->desa_id); ?> </td>
                                                    <th scope="row"> <?php echo e($data->nama_desa); ?> </th>
                                                    <td> <?php echo e($data->kecamatan->nama_kecamatan); ?> </td>
                                                    <td> <?php echo e($data->alamat_kantor_desa); ?> </td>
                                                    <td>
                                                        <?php if($data->status_desa == "1"): ?>
                                                            <span class="right badge badge-info">Aktif</span>
                                                        <?php else: ?>
                                                        <span class="right badge badge-secondary">Tidak Aktif</span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>  <?php echo e($data->desa_jenis); ?> </td>
                                                    <td class="text-centre">
                                                        <a href="#" class="btn btn-sm btn-flat btn-warning" data-toggle="modal" data-target="#edit<?php echo e($data->desa_id); ?>"><i class="fa fa-edit"></i></a>
                                                        
                                                        <button class="btn btn-sm btn-flat btn-danger" data-toggle="modal" data-target="#delete<?php echo e($data->desa_id); ?>"><i class="fa fa-trash"></i></button>
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="card-footer py-4">
                                                <?php echo e($desa->links('vendor.pagination.bootstrap-4')); ?>
      ...
      <!-- Modal Add -->
      <?php echo $__env->make('superadmin.masterdata.wilayah.add-desa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

      <!-- Modal Edit -->
      <?php echo $__env->make('superadmin.masterdata.wilayah.edit-desa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php $__currentLoopData = $desa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="delete<?php echo e($data->desa_id); ?>">
        <div class="modal-dialog">
            <div class="modal-content bg-secondary">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e($data->nama_desa); ?></h4>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="/delete-desa/<?php echo e($data->desa_id); ?>" type="button" class="btn btn-outline-light">Yes</a>
            </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
<?php /**PATH D:\Teknologi Informasi\Tugas Akhir\PROJECT\SirajaProject\resources\views/superadmin/masterdata/wilayah/desa.blade.php ENDPATH**/ ?>